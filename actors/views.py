...
from .serializers import (
    ActorReadSerializer, ActorWriteSerializer,
)


class ActorListView(generics.ListAPIView):
    queryset = Actor.objects.all()
    serializer_class = ActorReadSerializer
...
class ActorCreateView(generics.CreateAPIView):
    queryset = Actor.objects.all()
    serializer_class = ActorWriteSerializer
    permission_classes = [permissions.IsAuthenticated]
...
class ActorDestroyListView(generics.GenericAPIView):
    queryset = Actor.objects.all()
    permission_classes = [permissions.IsAuthenticated]
